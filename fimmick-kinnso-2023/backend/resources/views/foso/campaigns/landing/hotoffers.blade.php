...
<ul class="nav nav-tabs" role="tablist">
	...
	<li class="nav-item"> <a class="nav-link active" href='{{ route("foso.campaigns.landing.hotoffers.html") }}' role="tab"><span class="hidden-sm-up"><i class="fa fa-credit-card"></i></span> <span class="hidden-xs-down">Hot Offers</span></a> </li>
</ul>
		...
		<div class="row">
			<div class="col-sm-12">
				...
				array(
					"offer-id"=>1,
					"tags"=>array("熱門"),
					"key-visual"=>"https://www.kinnso.com/images/icon_01.png",
					"labels"=>array(
						array("text"=>"優惠", "text-color"=>"#FCCC08"),
						array("text"=>"美食", "text-color"=>"#EF8EA0"),
					),
					"title"=>"米芝蓮星級餐廳優惠攻略",
					"url"=>"https://www.kinnso.com/offer/001",
				),
			</div>
		</div>
	</div>
