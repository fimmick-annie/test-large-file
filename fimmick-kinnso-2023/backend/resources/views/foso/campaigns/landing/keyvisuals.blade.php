...
@section('page_title', 'Landing')

@section('breadcrumb_train')
<li><i class='fa fa-angle-right'></i><a href='{{ route("foso.campaigns.landing.keyvisuals.html") }}'>Landing</a></li>
@endsection

@section('content')

<ul class="nav nav-tabs" role="tablist">
	<li class="nav-item"> <a class="nav-link active" href='{{ route("foso.campaigns.landing.keyvisuals.html") }}' role="tab"><span class="hidden-sm-up"><i class="fa fa-film"></i></span> <span class="hidden-xs-down">Key Visuals</span></a> </li>
	...
	<li class="nav-item"> <a class="nav-link" href='{{ route("foso.campaigns.landing.banners.html") }}' role="tab"><span class="hidden-sm-up"><i class="fa fa-file-image-o"></i></span> <span class="hidden-xs-down">Banners</span></a> </li>
...
<div class='card' style="margin-bottom:10px">
	<div class='card-body'>
		...
		<div id="keyVisualList" class="list-group"></div>
	</div>
</div>
