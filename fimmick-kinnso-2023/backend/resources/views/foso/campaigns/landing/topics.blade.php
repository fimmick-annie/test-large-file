...
<ul class="nav nav-tabs" role="tablist">
	...
	<li class="nav-item"> <a class="nav-link active" href='{{ route("foso.campaigns.landing.topics.html") }}' role="tab"><span class="hidden-sm-up"><i class="fa fa-filter"></i></span> <span class="hidden-xs-down">Topics</span></a> </li>
...
<div class='card' style="margin-bottom:10px">
	<div class='card-body'>
		<div class="row">
			<div class="col-sm-12">
				<h4>Topics</h4>
				array("text"=>"盆菜", "text-color"=>"#F37621"),
			</div>
		</div>
	</div>
</div>
