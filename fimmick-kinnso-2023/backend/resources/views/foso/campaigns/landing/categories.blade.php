...
<ul class="nav nav-tabs" role="tablist">
	...
	<li class="nav-item"> <a class="nav-link active" href='{{ route("foso.campaigns.landing.categories.html") }}' role="tab"><span class="hidden-sm-up"><i class="fa fa-tags"></i></span> <span class="hidden-xs-down">Categories</span></a> </li>
...
<div class='card' style="margin-bottom:10px">
	<div class='card-body'>
		<div class="row">
			<div class="col-sm-12">
				<h4>Category</h4>
				array("text"=>"好去處", "icon"=>"https://www.kinnso.com/images/icon_01.png"),
			</div>
		</div>
	</div>
</div>
