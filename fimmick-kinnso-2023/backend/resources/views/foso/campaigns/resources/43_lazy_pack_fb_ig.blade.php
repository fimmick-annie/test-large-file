					<div class="row">
						<div class="col-sm-10">
							<h3><u><b>43. Lazy Pack with Facebook &amp; Instagram, no coupon site</b></u></h3>
						</div>
						<div class="col-sm-2">
...
@enderror
						...
						<div class="col-sm-3 my-2">
							<label for="input-file-now">Facebook Button</label>
							<div class="upload-area {{ $errors->has('offer_facebook_button') ? 'error' : '' }}">
								<input type="file" class="dropify" name="offer_facebook_button" data-max-file-size="2M" data-default-file="{{ asset('offers/'.$offer->offer_name.'/offer_facebook_button.png') }}?v={{ now()->format('dHis') }}.png" />
							</div>
@error('offer_facebook_button')
							<span class="invalid-feedback" style="display: block;">{{ $message }}</span>
@enderror
							<small class="form-text text-muted">726 x 108, PNG</small>
						</div>
						<div class="col-sm-3 my-2">
							<label for="input-file-now">Facebook Button (Clicked)</label>
							<div class="upload-area {{ $errors->has('offer_facebook_button_highlight') ? 'error' : '' }}">
								<input type="file" class="dropify" name="offer_facebook_button_highlight" data-max-file-size="2M" data-default-file="{{ asset('offers/'.$offer->offer_name.'/offer_facebook_button_highlight.png') }}?v={{ now()->format('dHis') }}.png" />
							</div>
@error('offer_facebook_button_highlight')
							<span class="invalid-feedback" style="display: block;">{{ $message }}</span>
@enderror
							<small class="form-text text-muted">726 x 108, PNG</small>
						</div>
					...
					<div class="row">
						...
						<div class="col-lg-12">
							<fieldset class="form-group">
								...
								<input class="form-control" type="text" value="{{ $offer->ini['offer_details']['facebook_link']??'' }}" id="facebook_link" name="facebook_link" placeholder="https://www.fb.com/fimmick">
							</fieldset>
						</div>
						<div class="col-lg-12">
							<fieldset class="form-group">
							...
							$("#saveButton").click(function()  {
								var basicRule = {
									...
									messages: {
										...
										facebook_link:  {minlength:"Must consist of at least 12 characters"},
