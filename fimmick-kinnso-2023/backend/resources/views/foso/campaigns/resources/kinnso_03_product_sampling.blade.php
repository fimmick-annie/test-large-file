					<div class="row"><div class="col-sm-12"><h3><u><b>#3 Product Sampling</b> Template Resources Page</u></h3></div></div>
					<br>
...
@enderror
						...
						<div class="col-sm-3 my-2">
							...
							<div class="upload-area {{ $errors->has('coupon_submit_button') ? 'error' : '' }}">
								<input type="file" class="dropify" name="coupon_submit_button" data-max-file-size="2M" data-default-file="{{ asset('offers/'.$offer->offer_name.'/coupon_submit_button.png') }}?v={{ now()->format('dHis') }}.png" />
							</div>
@error('coupon_submit_button')
							<span class="invalid-feedback" style="display: block;">{{ $message }}</span>
@enderror
							<small class="form-text text-muted">726 x 108, PNG</small>
						</div>
