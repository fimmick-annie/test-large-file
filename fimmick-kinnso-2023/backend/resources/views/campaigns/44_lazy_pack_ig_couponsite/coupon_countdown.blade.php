			...
			<form id="form" class="form__redemption" onsubmit="return handleSubmit(event)"><center>
				...
				<div class="form__main" style="width:65%;">
					...
					<div class="form__row">
						...
						<label for="pickedRedemptionStoreCode" class="inputLabel">店舖編碼 (由職員填寫）</label>
						<p class="errormsg"></p>
					</div>
				...
				<div class="form__submitbox">
					<a id="submit" class="form__submit">
						<img src="{{ asset('offers/'.$offer->offer_name.'/coupon_submit_button.png') }}?v=1" alt="" style="max-width: 250px; width:65%;">
					</a>
				</div>
