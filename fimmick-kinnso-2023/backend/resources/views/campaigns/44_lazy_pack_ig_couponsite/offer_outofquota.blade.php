				...
				<div class="bottom-wrapper">
					<div class="bottom-inner-wrapper">
						<div class="checkbox">
							...
							<label for="confirm_tnc">本人同意 Kinnso <a href="{{ route('website.termsandconditions.html') }}" target="_blank">條款及細則</a>和<a href="{{ route('website.privacy.html') }}" target="_blank">私隱政策聲明</a>。</label>
						</div>
