...
@endif
		...
		<div class="wrapper">
			...
			<div style="padding-top:50px; text-align:center;">
				...
				<p class="title">已成功換領</p>

				<img src="{{ asset('offers/common/bear_coupon_success.svg') }}?v=1" alt="Thank you!" />

				<p><a style="padding-top:20px;"><a href="{{ route('campaign.offer.listing.html') }}">
					<img src="{{ asset('offers/common/button_more_offer.svg') }}?v=1" alt="find more offer" style="padding:5%;"/>
				</a></p>
